export const meta = {
  ...
  description: 'Label 836 candidate skills as knowledge-work vs not, and real vs toy/meta, in 6 parallel batches',
  phases: [{ title: 'Classify', detail: '6 agents x ~140 skills each' }],
}
