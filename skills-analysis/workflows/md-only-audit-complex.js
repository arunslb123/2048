export const meta = {
  name: 'md-only-audit-complex',
  description: 'For complex-output finance/legal/HR/ops/reporting skills: what they produce, what they depend on outside SKILL.md, and whether they work uploaded alone into a 20-file markdown-only UI; then adversarially verify',
  phases: [
...
TASK. Read ${SP}/${args.dir}/batch${i}.tsv (columns: id, group, publisher, repo, name, skill_dir_abs_path). For EVERY row (one entry per id):
